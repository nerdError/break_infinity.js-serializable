...
var pad_end_1 = __importDefault(require("pad-end"));
...
var ME = function (mantissa, exponent) {
    return new Decimal().fromMantissaExponent(mantissa, exponent);
};
var ME_NN = function (mantissa, exponent) {
...
var Decimal = /** @class */ (function () {
    ...
    Decimal.prototype.toExponential = function (places) {
        ...
        if (this.e <= -EXP_LIMIT || this.m === 0) {
            return "0" + (places > 0 ? pad_end_1.default(".", places + 1, "0") : "") + "e+0";
        }
        // two cases:
    ...
    Decimal.prototype.toFixed = function (places) {
        ...
        if (this.e <= -EXP_LIMIT || this.m === 0) {
            return "0" + (places > 0 ? pad_end_1.default(".", places + 1, "0") : "");
        }
        // two cases:
        ...
        if (this.e >= MAX_SIGNIFICANT_DIGITS) {
            return this.m.toString()
                .replace(".", "")
                .padEnd(this.e + 1, "0") + (places > 0 ? pad_end_1.default(".", places + 1, "0") : "");
        }
    ...
    Decimal.prototype.pow = function (value) {
        ...
        var numberValue = value instanceof Decimal ? value.toNumber() : value;
